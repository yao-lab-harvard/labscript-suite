...
PulseBlasterESRPro500(name= 'pb', loop_number = numIterations,  extra_flags = 0, extra_inst = 3, extra_inst_data = 2, extra_length= 10, inst_location = 7, additional_inst = 8, loop_start = 0, board_number = 0, programming_scheme = 'pb_start/BRANCH')
