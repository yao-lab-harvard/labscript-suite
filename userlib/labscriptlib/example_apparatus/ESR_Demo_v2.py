...
PulseBlasterESRPro500(name= 'pb', loop_number = 2*numIterations,  extra_flags = 0, extra_inst = 3, extra_inst_data = 2, extra_length= 10, inst_location = 7, additional_inst = 8,
                         loop_start = 0, board_number = 0, programming_scheme = 'pb_start/BRANCH') #our pulseblaster; for ESR, numIterations = N_data_points*repetitions
ClockLine(name = "pb_clockline", pseudoclock = pb.pseudoclock, connection = "flag 0") #specialized clockline for NI DAQ
ClockLine(name = "pb_clockline_2", pseudoclock = pb.pseudoclock, connection = "flag 5") #dummy clockline because every device needs a clockline
...
PiezoEO(name = 'EO', parent_device = pb_clockline_2) #defining piezo
