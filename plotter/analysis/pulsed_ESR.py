...
plot_parameters_dict = {'titles': ["Pulsed ESR at 10 us initialization, 50 ns MW pulse", "Contrast"], 'xlabels': ["Freq (MHz)", "Freq (MHz)"], 'ylabels': ["Counts", "sig/ref"], "labels": ['[ref,sig]', " "] }
...
while True:
    ...
    for k in range(0,xList_len):
        for file_b in file_list:
            if int(file_b[130:133]) == k and file_b not in used_files:
                try:
